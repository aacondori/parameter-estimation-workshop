...
**A Two-Phase Program for High School Students**
...
- **Mathematical Identity Index** (pre/post/follow-up surveys)
- **Code Portfolio Rubric** (correctness, quality, documentation)
- **Poster/Report Rubric** (scientific communication)
- **Presentation Rubric** with peer feedback
- **Career Awareness Survey** (pre/post comparison)
...
*This program is supported by the Mathematical Association of America (MAA).*
